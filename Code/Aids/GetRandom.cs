...
public static class GetRandom
{
    ...
    public static object UInt16(ushort min = ushort.MinValue, ushort max = ushort.MaxValue) => (ushort)Int32(min,max);
    public static object UInt32(uint min = uint.MinValue, uint max = uint.MaxValue) => (uint)Int64(min,max);
